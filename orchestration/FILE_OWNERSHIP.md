...
**Base commit:** `BASE_LAUNCH` = `2df90ff0a97bbb4ca15fc0dd4bfb8fdefa6f4ebe`.

| Task ID | Agent | Owned paths | Shared contracts | Forbidden paths | Base commit |
|---|---|---|---|---|---|
| LAUNCH-T01 | docs-readme | `readme.md` | Slon Quick Start | everything else; no secrets | `2df90ff0a97bbb4ca15fc0dd4bfb8fdefa6f4ebe` |
| LAUNCH-T02 | docs-launch-runbook | `docs/audit/launch-runbook.md` | Privacy + first-run | `readme.md`, app code | `2df90ff0a97bbb4ca15fc0dd4bfb8fdefa6f4ebe` |
| LAUNCH-T03 | tooling-preflight | `mark/app/preflight.py`, `mark/app/__main__.py` (preflight entry only), `tests/unit/app/test_preflight.py` | exit 0/1 report, no secret values | `setup_wizard.py` behavior rewrite, `ui.py`, `main.py`, `readme.md`, network install | `2df90ff0a97bbb4ca15fc0dd4bfb8fdefa6f4ebe` |
