...
| Task ID | Agent | Owned paths | Shared contracts | Forbidden paths | Base commit |
|---|---|---|---|---|---|
| LAUNCH-T01 | docs-readme | `readme.md` | Slon Quick Start | everything else; no secrets | `f729ccdbe1f46275b2abf80c467998376376634a` || LAUNCH-T02 | docs-launch-runbook | `docs/audit/launch-runbook.md` | Privacy + first-run | `readme.md`, app code | `f729ccdbe1f46275b2abf80c467998376376634a` || LAUNCH-T03 | tooling-preflight | `mark/app/preflight.py`, `mark/app/__main__.py` (preflight entry only), `tests/unit/app/test_preflight.py` | exit 0/1 report, no secret values | `setup_wizard.py` behavior rewrite, `ui.py`, `main.py`, `readme.md`, network install | `f729ccdbe1f46275b2abf80c467998376376634a` || LAUNCH-T04 | ui-assets | `ui.py` (face load / HUD fallback / one SYS log only) | missing `face.png` safe | `main.py`, `config/**`, requirements | after Group A integrate |
