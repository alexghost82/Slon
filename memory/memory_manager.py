...
def extract_memory(user_text: str, assistant_text: str, api_key: str = "") -> dict:
    try:
        ...
        raw = client.chat(
            ...
            f"                  (e.g. slon: 'Building a personal AI assistant')\n"
            ...
            f"- Extract from BOTH user and Slon turns.\n"
            ...
            f' "projects":{{"slon":{{"value":"personal AI assistant"}}}},\n'
